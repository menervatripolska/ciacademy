            ...
            <div className="relative p-10 rounded-3xl bg-gradient-to-br from-[#0f1328] to-[#141a3a] neon-box-green overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="grid grid-cols-2 gap-3 mb-8 text-left">
                  {[
                    "8 уроков Crypto OS",
                    "Анимационный формат ~2.5 часа",
                    "9 практических артефактов",
                    "Macro & Crypto Multiplier",
                    "Portfolio Map + DCA",
                    "Signal Map + Anti-Hamster Filter",
                    "Доступ навсегда",
                    "Обновления курса",
...
function FAQSection() {
  const faqs = [
    { q: "Нужен ли опыт в криптовалютах?", a: "Нет. Первый урок начинается с того, как устроены деньги и инфляция — до крипты мы дойдём ко второму уроку. Курс спроектирован для новичка, у которого есть сбережения и есть желание разобраться." },
    { q: "Сколько времени нужно на прохождение?", a: "8 уроков Crypto OS, общий тайминг ~2.5 часа. Смотришь в своём ритме. Применение (настройка портфеля, DCA, watchlist) — ещё 1–2 часа. Доступ навсегда." },
    { q: "Чем это отличается от школ трейдинга?", a: "Это курс не про трейдинг. Мы строим операционную систему капитала: макро → смысл → распределение → подтверждение. Никаких фьючерсов, плеч, копирования чужих сделок и «сигналов на сегодня»." },
    { q: "Это финансовая рекомендация?", a: "Нет. Курс носит строго образовательный характер и не является индивидуальной инвестиционной рекомендацией в понимании ст. 3 Закона РК «О рынке ценных бумаг», а также не является финансовой, налоговой или юридической консультацией. Все решения ты принимаешь сам." },
    { q: "Что с биржами и ботами?", a: "Мы показываем, как работают спотовые биржи, DEX и DCA-сервисы на уровне инфраструктуры — без рекомендаций конкретных площадок и без реферальных ссылок. Боты — учебный инструмент для DCA-автозакупа, который ты настраиваешь сам. Копитрейдинга нет." },
    ...
    { q: "Что будет после курса?", a: "Финальный урок даёт карту из 5 следующих треков (AI-агенты, DEX, prediction-рынки, опционы, funding). Дальше — твой выбор глубины." },
  ];
    ...
    <footer className="relative py-12 border-t border-white/5">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-gray-500 text-xs text-center max-w-2xl leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
            Crypto Intelligence Academy — образовательная платформа. Материалы курса не являются индивидуальной инвестиционной рекомендацией в понимании ст. 3 Закона РК «О рынке ценных бумаг» и не являются финансовой, налоговой или юридической консультацией. Решения о покупке, продаже или удержании цифровых активов вы принимаете самостоятельно и на свой страх и риск. Доходность не гарантируется.
            <br />
            <a href="/offer" className="underline hover:text-gray-300 mx-1">Публичная оферта</a>·
            <a href="/privacy" className="underline hover:text-gray-300 mx-1">Политика ПДн</a>·
            <a href="/terms" className="underline hover:text-gray-300 mx-1">Пользовательское соглашение</a>
          </p>
